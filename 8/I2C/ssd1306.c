...
void print_test_screen_SSD(void) {
	...
	char buf[32];
	 {
		...
		SSD1306_GotoXY(1, 16);
		SSD1306_Puts("addr:", &Font_7x10, SSD1306_COLOR_WHITE); //1 String

		sprintf(buf, "%d", _soft++ );
		SSD1306_GotoXY(1+35, 16);
		SSD1306_Puts("        ", &Font_7x10, SSD1306_COLOR_WHITE);
		SSD1306_Puts(buf, &Font_7x10, SSD1306_COLOR_WHITE); //1 String
...
void
print_window_screen_SSD(uint8_t *active_window){
	...
	char buf[32];
	 {
		...
		sprintf(buf, "%d", (int)active_window );
		SSD1306_GotoXY(1+35, 16);
		SSD1306_Puts("        ", &Font_7x10, SSD1306_COLOR_WHITE);
		SSD1306_Puts(buf, &Font_7x10, SSD1306_COLOR_WHITE); //1 String
