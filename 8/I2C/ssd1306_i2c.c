...
/* Private variables */
static uint32_t ssd1306_I2C_Timeout = 1000;
...
extern uint32_t SSDerr;
extern uint32_t timeoutI2C;
...
/*
    ...
    i2c.I2C_ClockSpeed = 100000;//400000 170000
    i2c.I2C_Mode = I2C_Mode_I2C;
    i2c.I2C_DutyCycle = I2C_DutyCycle_2;
    i2c.I2C_OwnAddress1 = 0x78;
...
uint8_t ssd1306_I2C_WriteData(I2C_TypeDef* I2Cx, uint8_t data) {
	...
	timeoutI2C = ssd1306_I2C_Timeout;
	/* Send I2C data */
	I2Cx->DR = data;
	return 0;
}
...
void ssd1306_I2C_Write(I2C_TypeDef* I2Cx, uint8_t address, uint8_t reg, uint8_t data) {
	if( ssd1306_I2C_Start(I2Cx, address, I2C_TRANSMITTER_MODE, I2C_ACK_DISABLE))
	{
		SSDerr++;
		return;
	}
...
void turnOffPB14(void){
	  ...
	  LL_GPIO_ResetOutputPin(LCD_on_GPIO_Port, LCD_on_Pin);
}

void TurnOnPB14(void){
...
void turnOnPB14(void){
	...
	LL_GPIO_SetOutputPin(LCD_on_GPIO_Port, LCD_on_Pin);
};
